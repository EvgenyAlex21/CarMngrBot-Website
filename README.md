...
**Пользователь 1** - основная информация для пользователя
![Информация](/images/project_view/Пользователь(1).png)

**Пользователь 2** - просмотр функций пользователя
![Карточки функций](/images/project_view/Пользователь(2).png)

**Пользователь 3** - подробная инструкция по использованию функций пользователя
![Инструкция](/images/project_view/Пользователь(3).png)

**Пользователь 4** - пользовательское соглашение
![Соглашение](/images/project_view/Пользователь(4).png)

**Пользователь 5** - политика конфиденциальности
![Политика](/images/project_view/Пользователь(5).png)

### Страница для администратора

**Администратор 1** - основная информация для администратора
![Информация](/images/project_view/Администратор(1).png)

**Администратор 2** - просмотр функций пользователя
![Карточки функций](/images/project_view/Администратор(2).png)

**Администратор 3** - подробная инструкция по использованию функций администратора
![Инструкция](/images/project_view/Администратор(3).png)

### Страница для мобильных устройств

**Пользователь (мобильная)** - адаптация пользовательской страницы под мобильное устройство
![Пользователь](/images/project_view/Мобильная(пользователь).png)

**Администратор (мобильная)** - адаптация админской страницы под мобильное устройство
![Администратор](/images/project_view/Мобильная(администратор).png)
