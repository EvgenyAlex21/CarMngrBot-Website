...
<div align="center">
  ...
  [![Website](https://img.shields.io/badge/Website-carmngrbot.com.swtest.ru-blue?style=for-the-badge&logo=chrome)](ht### 🌐 Основные ресурсы
- 🌍 [**Информационный сайт**](http://carmngrbot.com.swtest.ru) — полная документация бота
- 🔐 [**Админ-панель**](http://carmngrbot.com.swtest.ru/admin.html) — управление ботом (только для администраторов)
- 🤖 [**Telegram-бот**](https://t.me/CarMngrBot) — запуск и использование
- 📢 [**Новостной канал**](https://t.me/CarMngrBot_news) — обновления и новости

### 📚 Документация
- 📖 [**Полная инструкция**](http://carmngrbot.com.swtest.ru/#instructions) — руководства по использованию
- 🛡️ [**Пользовательское соглашение**](http://carmngrbot.com.swtest.ru/#agreement) — условия использования
- 🔒 [**Политика конфиденциальности**](http://carmngrbot.com.swtest.ru/#privacy) — защита данных
- ❓ [**FAQ и поддержка**](https://t.me/CarMngrBot) — частые вопросы через бота
...
- 📝 **Контент**: новости, реклама, коммуникацииcarmngrbot.com.swtest.ru)
...
| 🆓 Бесплатные | 👑 Премиум |
|:-------------:|:-----------:|
| Автокредит | Расход топлива |
| Цены на топливо | Алкоголь |
| Код региона | Траты и ремонты |
| Коды OBD2 | Найти транспорт |
| Напоминания | Поиск мест |
| Антирадар (базовый) | Погода |
| Новости | Налоги |
| Бланки | Растаможка |
| Реклама | ОСАГО |
| Чат с админом | Шины |
...
├── 📄 admin.html          # Административная панель (вход через бота)
├── � README.md           # Этот файл
├── �📁 css/
│   ├── styles.css         # Основные стили сайта
│   └── fontawesome.css    # Стили для иконок FontAwesome
├── 📁 js/
...
└── 📁 fronts/
    └── fontawesome-free-5/ # Шрифты и иконки FontAwesome
        ├── css/
        │   └── all.min.css
        └── webfonts/
            ├── fa-brands-400.*
...
- **Финансовые операции** — управление баллами, магазином, промокодами
- **Модерация контента** — публикация новостей, управление рекламой
- **Коммуникации** — чат с пользователями, массовые оповещения
- **Безопасность** — блокировка пользователей, права доступа
...
- 🎨 **Современный UI/UX** — использование современных CSS техник
- ⚡ **Оптимизация** — быстрая загрузка и производительность
- 🔧 **Кроссбраузерность** — поддержка всех современных браузеров
- � **Полная документация** — подробное описание всех функций бота
- 🏷️ **Семантическая разметка** — корректная HTML-структура
...
4. **Обновите браузер** для просмотра результата

### Структура стилей

```css
/* Основные компоненты */
.corporate-header { /* Шапка сайта */ }
.corporate-nav { /* Навигационное меню */ }
.section-container { /* Контейнеры разделов */ }
.function-card { /* Карточки функций */ }
.corporate-footer { /* Подвал сайта */ }
```

### JavaScript функции

- **Навигация** — плавная прокрутка к разделам (`smoothScroll`)
- **Мобильное меню** — управление отображением на мобильных устройствах
- **Дропдауны** — раскрывающиеся меню в навигации
- **Анимации** — эффекты появления элементов при прокрутке
- **Админ-панель** — базовая структура для административного интерфейса
